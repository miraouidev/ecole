 ...
 */
final class Version20250906203207 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE admininstrateur (id INT AUTO_INCREMENT NOT NULL, civilite_id INT NOT NULL, nom_fr VARCHAR(100) NOT NULL, nom_ar VARCHAR(100) NOT NULL, prenom_fr VARCHAR(100) NOT NULL, prenom_ar VARCHAR(100) NOT NULL, date_nai DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', start_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', cin VARCHAR(15) DEFAULT NULL, phone VARCHAR(15) DEFAULT NULL, mobile VARCHAR(15) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, INDEX IDX_60F08A0A39194ABF (civilite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE annee_scolaire_courante (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(100) NOT NULL, date_debut DATETIME NOT NULL, date_fin DATETIME NOT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE civilite (id INT AUTO_INCREMENT NOT NULL, nom_fr VARCHAR(100) NOT NULL, nom_ar VARCHAR(100) NOT NULL, code VARCHAR(10) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE eleve (id INT AUTO_INCREMENT NOT NULL, groupe_id INT DEFAULT NULL, nom_fr VARCHAR(100) NOT NULL, nom_ar VARCHAR(100) NOT NULL, prenom_fr VARCHAR(100) NOT NULL, prenom_ar VARCHAR(100) NOT NULL, date_nai DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_ECA105F77A45358C (groupe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE matieres (id INT AUTO_INCREMENT NOT NULL, niveau_id INT DEFAULT NULL, nom_fr VARCHAR(100) NOT NULL, nom_ar VARCHAR(100) NOT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, INDEX IDX_8D9773D2B3E9C81 (niveau_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE niveau (id INT AUTO_INCREMENT NOT NULL, nom_fr VARCHAR(100) NOT NULL, nom_ar VARCHAR(100) NOT NULL, code VARCHAR(10) NOT NULL, UNIQUE INDEX UNIQ_4BDFF36B77153098 (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE parent_eleve_relation (id INT AUTO_INCREMENT NOT NULL, eleve_id INT NOT NULL, parent_id INT NOT NULL, type_relation_id INT NOT NULL, INDEX IDX_68B9D536A6CC7B2 (eleve_id), INDEX IDX_68B9D536727ACA70 (parent_id), INDEX IDX_68B9D536794F46CA (type_relation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE parent_profile (id INT AUTO_INCREMENT NOT NULL, civilite_id INT DEFAULT NULL, nom_fr VARCHAR(100) NOT NULL, nom_ar VARCHAR(100) NOT NULL, prenom_fr VARCHAR(100) NOT NULL, prenom_ar VARCHAR(100) NOT NULL, date_nai DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', start_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', cin VARCHAR(15) DEFAULT NULL, phone VARCHAR(15) DEFAULT NULL, mobile VARCHAR(15) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, INDEX IDX_F31FDE4939194ABF (civilite_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE refresh_tokens (id INT AUTO_INCREMENT NOT NULL, refresh_token VARCHAR(128) NOT NULL, username VARCHAR(255) NOT NULL, valid DATETIME NOT NULL, UNIQUE INDEX UNIQ_9BACE7E1C74F2195 (refresh_token), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE role_app (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, info VARCHAR(255) DEFAULT NULL, code VARCHAR(30) NOT NULL, UNIQUE INDEX UNIQ_7D0CF4BD77153098 (code), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE site_event (id INT AUTO_INCREMENT NOT NULL, langue_id INT NOT NULL, titre VARCHAR(255) DEFAULT NULL, text VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, lien_page VARCHAR(255) DEFAULT NULL, INDEX IDX_FFF4DAA22AADBACD (langue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE site_event_ticket (id INT AUTO_INCREMENT NOT NULL, langue_id INT NOT NULL, image VARCHAR(255) DEFAULT NULL, date DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', hour_start VARCHAR(10) DEFAULT NULL, hour_end VARCHAR(10) DEFAULT NULL, titre VARCHAR(255) DEFAULT NULL, text VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, lien_page VARCHAR(255) DEFAULT NULL, INDEX IDX_6EB347422AADBACD (langue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE site_footer (id INT AUTO_INCREMENT NOT NULL, langue_id INT NOT NULL, text VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, lien_page VARCHAR(255) DEFAULT NULL, INDEX IDX_929FAB0C2AADBACD (langue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE site_header (id INT AUTO_INCREMENT NOT NULL, langue_id INT NOT NULL, phone VARCHAR(20) DEFAULT NULL, logo VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, adresse VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, lien_page VARCHAR(255) DEFAULT NULL, INDEX IDX_1EDC069E2AADBACD (langue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE site_our_program (id INT AUTO_INCREMENT NOT NULL, langue_id INT NOT NULL, titre VARCHAR(255) DEFAULT NULL, text VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, lien_page VARCHAR(255) DEFAULT NULL, INDEX IDX_E3700BD2AADBACD (langue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE site_our_program_ticket (id INT AUTO_INCREMENT NOT NULL, langue_id INT NOT NULL, image VARCHAR(255) DEFAULT NULL, titre VARCHAR(255) DEFAULT NULL, text VARCHAR(255) DEFAULT NULL, prix DOUBLE PRECISION DEFAULT NULL, nombre INT DEFAULT NULL, nombre_heure INT DEFAULT NULL, lesson INT DEFAULT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, lien_page VARCHAR(255) DEFAULT NULL, INDEX IDX_DCEF77E52AADBACD (langue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE site_our_teams (id INT AUTO_INCREMENT NOT NULL, enseignant_id INT NOT NULL, ordre INT NOT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, UNIQUE INDEX UNIQ_31A61D3FE455FCC0 (enseignant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE site_page_generique (id INT AUTO_INCREMENT NOT NULL, titre VARCHAR(255) DEFAULT NULL, contenu LONGTEXT DEFAULT NULL, link_image VARCHAR(255) DEFAULT NULL, type_page VARCHAR(50) NOT NULL, url VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, create_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE site_reseau (id INT AUTO_INCREMENT NOT NULL, langue_id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, code VARCHAR(10) NOT NULL, link VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, lien_page VARCHAR(255) DEFAULT NULL, INDEX IDX_BD4B82E72AADBACD (langue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE site_testimonials (id INT AUTO_INCREMENT NOT NULL, langue_id INT NOT NULL, client_name VARCHAR(255) DEFAULT NULL, nombre_etoile INT DEFAULT NULL, text VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, lien_page VARCHAR(255) DEFAULT NULL, INDEX IDX_F3BB88CA2AADBACD (langue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE site_top_image (id INT AUTO_INCREMENT NOT NULL, langue_id INT NOT NULL, image VARCHAR(255) DEFAULT NULL, titre VARCHAR(255) DEFAULT NULL, text VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, lien_page VARCHAR(255) DEFAULT NULL, INDEX IDX_3628DB5E2AADBACD (langue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE site_we_what (id INT AUTO_INCREMENT NOT NULL, langue_id INT NOT NULL, titre VARCHAR(255) DEFAULT NULL, text LONGTEXT DEFAULT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, lien_page VARCHAR(255) DEFAULT NULL, INDEX IDX_36DFF89D2AADBACD (langue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE site_we_what_ticket (id INT AUTO_INCREMENT NOT NULL, langue_id INT NOT NULL, icone VARCHAR(255) DEFAULT NULL, titre VARCHAR(255) DEFAULT NULL, text VARCHAR(255) DEFAULT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, lien_page VARCHAR(255) DEFAULT NULL, INDEX IDX_C7A8895D2AADBACD (langue_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE type_relation (id INT AUTO_INCREMENT NOT NULL, nom_fr VARCHAR(100) NOT NULL, nom_ar VARCHAR(100) NOT NULL, code VARCHAR(10) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, admininstrateur_id INT DEFAULT NULL, parent_id INT DEFAULT NULL, username VARCHAR(180) NOT NULL, email VARCHAR(255) DEFAULT NULL, type VARCHAR(20) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, is_active TINYINT(1) DEFAULT 1 NOT NULL, UNIQUE INDEX UNIQ_8D93D6491707C25B (admininstrateur_id), UNIQUE INDEX UNIQ_8D93D649727ACA70 (parent_id), UNIQUE INDEX UNIQ_IDENTIFIER_USERNAME (username), UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE matiere_classe_prof ADD CONSTRAINT FK_74154339E455FCC0 FOREIGN KEY (enseignant_id) REFERENCES enseignant (id)');
        ...
        $this->addSql('ALTER TABLE parent_eleve_relation ADD CONSTRAINT FK_68B9D536794F46CA FOREIGN KEY (type_relation_id) REFERENCES type_relation (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE matiere_classe_prof DROP FOREIGN KEY FK_74154339E455FCC0');
        ...
        $this->addSql('ALTER TABLE parent_eleve_relation DROP FOREIGN KEY FK_68B9D536794F46CA');
        ...
        $this->addSql('DROP TABLE role_app');
